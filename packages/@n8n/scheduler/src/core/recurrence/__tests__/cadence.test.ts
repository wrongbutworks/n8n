import type { ScheduledJobRecurrenceUnit } from '@n8n/constants';

import type { RecurringCronSchedule } from '../../types';
import { isOnCadence, periodsBetween } from '../cadence';

const gate = (unit: ScheduledJobRecurrenceUnit, size: number): RecurringCronSchedule => ({
	kind: 'recurring_cron',
