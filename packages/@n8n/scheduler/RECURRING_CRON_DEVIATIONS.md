...
> It is not long-lived documentation and should be deleted once the branch is merged and the
> content has served its purpose (e.g. folded into the PR description).
